...
1.  **Start the local server:** Before running the extension, you must have the corresponding local server application running and listening for requests on `http://12.0.0.1:3000`. This server is responsible for receiving and processing the data sent by the extension.
